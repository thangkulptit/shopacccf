...
<html lang="en">
  ...
  <base href="{{asset('backend')}}/">
    ...
    <meta name="keyword" content="Bootstrap,Admin,Template,Open,Source,jQuery,CSS,HTML,RWD,Home">
    ...
    <link rel="stylesheet" type="text/css" href="../frontend/lib/toastr/toastr.min.css">
    <script src="../frontend/lib/toastr/toastr.min.js"></script>
    <link href="vendors/pace-progress/css/pace.min.css" rel="stylesheet">
    
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <script src="js/toast-lib.js"></script>
    <link rel="stylesheet" href="css/toast-lib.css">
<style>
...
@keyframes lds-ring {
 ...
 <div class="wrap-loading">
  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
      ...
      <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item" href="{{asset('logout')}}" alt="{{Auth::user()->email}}">
      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-title">Quản lý Account</li>
            <li class="nav-item">
              <a class="nav-link" href="/admin/home">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/admin/account">
                <i class="nav-icon icon-pencil"></i> AccountRandom</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/accounts">
                  <i class="nav-icon icon-pencil"></i> Account</a>
              </li>
            <li class="nav-title">Quản lý</li>
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-puzzle"></i> Quản lý Members</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
                  <a class="nav-link" href="{{url('/admin/members')}}">
                    <i class="nav-icon icon-puzzle"></i> Thành viên</a>
                </li>
              </ul>
            </li>
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-cursor"></i> Nạp thẻ</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
                  <a class="nav-link" href="{{url('/admin/card/top')}}">
                    <i class="nav-icon icon-cursor"></i> Top nạp thẻ</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('/admin/card/static')}}">
                    <i class="nav-icon icon-cursor"></i> Thống kê</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/card/history')}}">
                      <i class="nav-icon icon-cursor"></i> Lịch sử nạp</a>
                </li>
                
               </ul>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('/admin/account/history')}}">
                <i class="nav-icon icon-pie-chart"></i> Lịch sử Acc</a>
            </li>
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="{{url('/admin/account/history')}}">
                <i class="nav-icon icon-star"></i> Lịch sử mua acc</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
                  <a class="nav-link" href="icons/coreui-icons.html">
                    <i class="nav-icon icon-star"></i> Quản lý thẻ
    ...
    <script src="theme/@coreui/coreui-plugin-chartjs-custom-tooltips/dist/js/custom-tooltips.min.js"></script>
